    ...
    <div style={{ marginTop: '30px' }} className={`section-wrapper w-full  ${className || ""}`}>
      <div className="container-x mx-auto">
        <div className=" section-title flex justify-between items-center mb-5">
          <div>
            <h1 className="sm:text-2xl xsm:text-md ssm:text-lg text-sm font-600 text-_blue font-semibold uppercase leading-none">
              {categoryTitle}
            </h1>
          </div>
          <div>
            <Link href={seeMoreUrl}>
              <div className="flex space-x-2 items-center">
                <p className="sm:text-2xl xsm:text-md ssm:text-lg text-sm font-600 font-600 text-_blue hover:text-blue-400 font-bold">View More</p>
