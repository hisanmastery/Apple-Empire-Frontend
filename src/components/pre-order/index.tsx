        ...
        <div className="flex flex-col items-center py-10 bg-gray-50">
            ...
            <div className="bg-_white shadow-md rounded-lg p-6 w-full max-w-2xl">
                <form onSubmit={handleSubmit}>
                    {/* Product Information */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Product Information <span className='text-_orange'>*</span></label>
                        <input
                            type="text"
                    ...
                    {/* Image Upload */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Insert Image <span className='text-_orange'>*</span></label>
                        <input
                            type="file"
                            accept="image/*"
                    ...
                    {/* Name */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Name <span className='text-_orange'>*</span></label>
                        <input
                            type="text"
                    ...
                    <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-gray-700 font-medium mb-2">Phone <span className='text-_orange'>*</span></label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="block text-gray-700 font-medium mb-2">Email <span className='text-_orange'>*</span></label>
                            <input
                                type="email"
                    ...
                    {/* Address */}
                    <div className="mb-4">
                        <label className="block text-gray-700 font-medium mb-2">Address <span className='text-_orange'>*</span></label>
                        <textarea
