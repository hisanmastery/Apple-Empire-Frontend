            ...
            <div className="w-full h-full relative">
              <div className="w-full h-full flex justify-between items-center">
                ...
                <div className="category-and-nav lg:hidden flex xl:space-x-7 space-x-3 items-center">
                  <div
                      className="category w-[85vw] ssm:w-[88vw] msm:w-[90vw] smd:w-[270px] h-[40px] smd:h-[53px] bg-_white px-5 rounded-t-md mt-[6px] relative">
                    <button
                        onClick={handler}
                        type="button"
                    ...
                    {categoryToggle && (
                        <div
                            className="category-dropdown w-full absolute left-0 top-[43px] sm:top-[47px] smd:top-[53px]">
                        ...
                        {category.subCategory?.length > 0 ? (
                            ...
                            <span className="text-md font-600 hover:text-_orange text-qblacktext">
                              ...
                              {openCategoryId === category._id && (
                                  <div
                                      className="category-dropdown w-full min-w-48 absolute left-0 top-[43px] sm:top-[47px] smd:top-[53px]">
                                    <ul className="categories-list">
                                      {category.subCategory.map(
                                          (subCategory: string, subIndex: number) => (
                                              <li
                            ...
                            <Link href={`/category/${category.categoryName}`}>
                              <div
                                  className="w-full h-full flex justify-between text-center items-center cursor-pointer">
                                <div className="flex space-x-3 items-center">
                            <span className="text-md font-600 hover:text-_orange text-qblacktext">
                              {category.categoryName}
                            </span>
