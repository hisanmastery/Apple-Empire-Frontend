    ...
    <div>
      ...
      >
        ...
        <nav className="flex flex-col gap-6 mt-6 p-6">
          <Link
            href="/"
            className="flex items-center text-lg font-medium text-gray-800 hover:text-_blue transition-all duration-200"
          >
            <icons.HomeIcon className="w-5 h-5 mr-3 text-_blue" />
            Home
          </Link>
          <Link
            href="/section/popular-products"
            className="flex items-center text-lg font-medium text-gray-800 hover:text-_blue transition-all duration-200"
          >
