    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <Link href={"/section/popular-products"}>
                <img ref={popupRef} src={'https://cdn.grabon.in/gograbon/images/web-images/uploads/1618571140235/mobile-offers.jpg'} alt="Image... " height={100} width={100} className={' w-[90vw] max-w-[800px] rounded sm:w-[80vw]'} />
            </Link>
        </div>
    );
};
